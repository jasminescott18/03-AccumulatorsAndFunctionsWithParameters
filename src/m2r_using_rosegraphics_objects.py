...
#            Creates a RoseWindow that displays the objects created
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When you want the user to be able to decide when to close out the window.
#            It also helps show when the code is correct.
