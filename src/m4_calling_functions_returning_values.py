...
def run_test_digits_in_cube():
    ...
    # ------------------------------------------------------------------
    # COMPLETED: 3. Implement this function.
...
def run_test_digits_in_power():
    ...
    # ------------------------------------------------------------------
    # COMPLETED: 5. Implement this function.
...
def run_test_fancy_sums_of_digits():
    ...
    # ------------------------------------------------------------------
    # COMPLETED: 7. Implement this function.
